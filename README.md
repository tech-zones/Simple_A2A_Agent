...
This repo demonstrates a minimal A2A (Agent-to-Agent) agent implementation using Google's a2a-sdk & python-a2a. The agent is a simple Random Number Generator that responds to A2A-compliant requests by returning a number between 1 and 100. This is a great starting point if you're learning A2A.
...
This will start the A2A-compliant agent server on http://localhost:9000.
